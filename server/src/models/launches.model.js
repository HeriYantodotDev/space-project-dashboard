...
//to do : Check the function `findLaunch` whether it find for the object or just return boolean? 
...
console.log('You don\'t have the latest data! downloading data from SpaceX API');
